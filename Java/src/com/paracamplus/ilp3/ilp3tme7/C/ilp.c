...
ILP_costart(void (*f)(), int argc, ...)
{
     ...
     // contexte si la coroutine est terminée
     getcontext(end_ctx);
     ...
     // matcher avec l'arité de la fonction
     va_start(args, argc);
     switch(argc){
          case 0: {
...
ILP_yield()
{
     if (!current_coroutine) {
          return ILP_error("Yield sans coroutine !");
     }
     //de coroutine vers appelant
...
extern ILP_Object
ILP_resume(ILP_Object coroutine)
{
