...
public class Normalizer extends com.paracamplus.ilp3.compiler.normalizer.Normalizer
    ...
    public IASTexpression visit(IASTcostart iast, INormalizationEnvironment iNormalizationEnvironment) throws CompilationException {
        IASTexpression cor = iast.getCoroutine().accept(this, iNormalizationEnvironment);

        if(! (cor instanceof IASTCglobalVariable))
            throw new CompilationException("Fonction non globale");
        IASTCglobalVariable function = (IASTCglobalVariable)cor;
