...
import antlr4.ILPMLgrammar3tme7Parser.AlternativeContext;
import antlr4.ILPMLgrammar3tme7Parser.BinaryContext;
import antlr4.ILPMLgrammar3tme7Parser.BindingContext;
import antlr4.ILPMLgrammar3tme7Parser.CodefinitionsContext;
import antlr4.ILPMLgrammar3tme7Parser.ConstFalseContext;
import antlr4.ILPMLgrammar3tme7Parser.ConstFloatContext;
import antlr4.ILPMLgrammar3tme7Parser.ConstIntegerContext;
import antlr4.ILPMLgrammar3tme7Parser.ConstStringContext;
import antlr4.ILPMLgrammar3tme7Parser.ConstTrueContext;
import antlr4.ILPMLgrammar3tme7Parser.CostartContext;
import antlr4.ILPMLgrammar3tme7Parser.GlobalFunDefContext;
import antlr4.ILPMLgrammar3tme7Parser.InvocationContext;
import antlr4.ILPMLgrammar3tme7Parser.LambdaContext;
import antlr4.ILPMLgrammar3tme7Parser.LocalFunDefContext;
import antlr4.ILPMLgrammar3tme7Parser.LoopContext;
import antlr4.ILPMLgrammar3tme7Parser.ProgContext;
import antlr4.ILPMLgrammar3tme7Parser.SequenceContext;
import antlr4.ILPMLgrammar3tme7Parser.TryContext;
import antlr4.ILPMLgrammar3tme7Parser.UnaryContext;
import antlr4.ILPMLgrammar3tme7Parser.VariableAssignContext;
import antlr4.ILPMLgrammar3tme7Parser.VariableContext;
...
protected IASTfactory factory;
	...
	protected IASTexpression[] toExpressions(
			List<antlr4.ILPMLgrammar3tme7Parser.ExprContext> exprs) {
		if (exprs == null) return new IASTexpression[0];
		IASTexpression[] r = new IASTexpression[exprs.size()];
		int pos = 0;
		for (antlr4.ILPMLgrammar3tme7Parser.ExprContext e : exprs) {
			r[pos++] = e.node;
		}
		return r;
	}
	...
	protected IASTblock.IASTbinding[] toBindings(
			List<Token> vars, 
			List<antlr4.ILPMLgrammar3tme7Parser.ExprContext> vals) {
	...
	@Override
	public void exitCostart(
			CostartContext ctx) {
		ctx.node = factory.newCostart(
				ctx.fun.node,
				toExpressions(ctx.args));
